...
Partial Public Class Customer
	...
	<Global.System.Data.Linq.Mapping.AssociationAttribute(Name:="Customer_Order", Storage:="_Orders", ThisKey:="custID", OtherKey:="custID")>  _
...
Partial Public Class [Order]
	...
	Private _Payments As EntityRef(Of Payment)
	
	Private _Deliveries As EntityRef(Of Delivery)
	...
	Public Sub New()
		MyBase.New
		Me._Payments = CType(Nothing, EntityRef(Of Payment))
		Me._Deliveries = CType(Nothing, EntityRef(Of Delivery))
	...
	<Global.System.Data.Linq.Mapping.AssociationAttribute(Name:="Order_Payment", Storage:="_Payments", ThisKey:="orderID", OtherKey:="orderID", IsUnique:=true, IsForeignKey:=false)>  _
	Public Property Payments() As Payment
        Get
            Return Me._Payments.Entity
        End Get
        Set
			Dim previousValue As Payment = Me._Payments.Entity
			If ((Object.Equals(previousValue, value) = false)  _
						OrElse (Me._Payments.HasLoadedOrAssignedValue = false)) Then
				Me.SendPropertyChanging
				If ((previousValue Is Nothing)  _
							= false) Then
					Me._Payments.Entity = Nothing
					previousValue.[Order] = Nothing
				End If
				Me._Payments.Entity = value
				If (Object.Equals(value, Nothing) = false) Then
					value.[Order] = Me
				End If
				Me.SendPropertyChanged("Payments")
			End If
		End Set
	End Property
	
	<Global.System.Data.Linq.Mapping.AssociationAttribute(Name:="Order_Delivery", Storage:="_Deliveries", ThisKey:="orderID", OtherKey:="orderID", IsUnique:=true, IsForeignKey:=false)>  _
	Public Property Deliveries() As Delivery
		Get

        End Get
		Set
			Dim previousValue As Delivery = Me._Deliveries.Entity
			If ((Object.Equals(previousValue, value) = false)  _
						OrElse (Me._Deliveries.HasLoadedOrAssignedValue = false)) Then
				Me.SendPropertyChanging
				If ((previousValue Is Nothing)  _
							= false) Then
					Me._Deliveries.Entity = Nothing
					previousValue.[Order] = Nothing
				End If
				Me._Deliveries.Entity = value
				If (Object.Equals(value, Nothing) = false) Then
					value.[Order] = Me
				End If
				Me.SendPropertyChanged("Deliveries")
			End If
		End Set
	End Property
	...
	<Global.System.Data.Linq.Mapping.AssociationAttribute(Name:="Customer_Order", Storage:="_Customer", ThisKey:="custID", OtherKey:="custID", IsForeignKey:=true)>  _
		...
		Set
			...
			If ((Object.Equals(previousValue, value) = false)  _
				...
				If ((previousValue Is Nothing)  _
					...
					previousValue.Payments = Nothing
				End If
		...
		Set
			...
			If ((Object.Equals(previousValue, value) = false)  _
				...
				If ((previousValue Is Nothing)  _
							= false) Then
					Me._Order.Entity = Nothing
					previousValue.Deliveries = Nothing
				End If
				Me._Order.Entity = value
				If ((value Is Nothing)  _
							= false) Then
